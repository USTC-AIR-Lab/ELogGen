"""
Selection strategies used by ElogGen generation runtime to select subtask segments from 
...
class SelectionStrategyMeta(type):
    ...
    def __new__(meta, name, bases, class_dict):
        cls = super(SelectionStrategyMeta, meta).__new__(meta, name, bases, class_dict)
